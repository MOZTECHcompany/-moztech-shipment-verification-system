  ...
  return (
    <div className="min-h-screen bg-mesh relative overflow-x-hidden">
      ...
      <header className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-full max-w-7xl px-6">
        <div className="glass-panel rounded-2xl px-6 py-3 flex items-center justify-between transition-all duration-300 hover:scale-[1.005] shadow-lg shadow-black/5 border border-white/20 backdrop-blur-xl bg-white/40">
