                    ...
                    <div className="flex items-end gap-2">
                        <div className={`flex-1 bg-gray-50/50 rounded-[1.5rem] border border-transparent transition-all duration-300 flex flex-col focus-within:bg-white/80 focus-within:shadow-inner`}>
                            <textarea
                                ...
                                className="w-full px-5 py-3 bg-transparent border-none focus:ring-0 resize-none max-h-32 min-h-[48px] text-sm text-gray-900 placeholder:text-gray-400 caret-blue-500"
                                rows={1}
